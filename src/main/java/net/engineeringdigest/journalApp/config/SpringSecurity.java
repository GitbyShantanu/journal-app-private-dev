...
public class SpringSecurity extends WebSecurityConfigurerAdapter {
    ...
    // 2. request header aur db se mila Password ko internally verify karne ke liye passwordEncoder() implement karke bean dena hai spring ko e.g. BCrypt) for storing passwords in encoded format in mongodb and compare to verify.
